...
export default class ShowdataComputerEngineering extends Component{
    constructor() {
        super();
        this.state ={
            list:[],
    ...
    render() {
        ...
        return (
            <div className="App">
                <h2 className="my-4">Users Information ComputerEngineering<br/></h2>
                <hr/>
                        ...
                        <tbody>
                                {list.map((user) =>{
                                    return(
                                        <tr>
                                            <td>{user.ID_CG}</td>
                                            <td>{user.class_ComputerEngineering}</td>
